...
// fdesetup Errors
public enum FileVaultError: Error {
...
public func checkAuthRestart() -> Bool {
...
public func getFVEnabled() -> (encrypted: Bool, decrypting: Bool) {
...
public func hasRecoveryKey(path: String, useKeychain: Bool) -> Bool {
  if !useKeychain {
